...
//<!-- Modif:	-->
	...
	$FrmTitre=C_TITRE_TEST;
	$FrmAction="GesTest_D.php";
	$FrmQuitter="GesTest_L.php";
	$prg_Javascript='MAdm/JSGesTest.js';
	...
	require_once $_SERVER['DOCUMENT_ROOT'].C_SITE_REPERTOIRE."Includes/"."MAdm/GenTest_Class.php";
	...
	if ($Bdd == 1){
		...
		$cTest = new classTest();
		$cTest->InitClass($IdItem);
		$cTest->PutCode($Code);

		$Message = C_MES_SAVE_NOK;
		if ($cTest->GetCodeUnique($ActionPHP)){
			if ($cTest->Validate($ActionPHP)) {
