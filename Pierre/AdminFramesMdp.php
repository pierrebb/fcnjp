...
<frameset cols="220,*" framespacing="0" frameborder="0" name="second" id="second">
		<frame src="AdminMenuMdp.php" name="menu" id="menu" frameborder="0" scrolling="Auto" noresize marginwidth="0" marginheight="0">
		<frame src='www/MAdm/GesMdP_D.php' name='contenu' id='contenu' frameborder='0' scrolling='Auto' noresize marginwidth='0' marginheight='0'>
