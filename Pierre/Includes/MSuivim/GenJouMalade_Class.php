...
class classJouMalade{
	...
	function GetDateReprise(){return $this->DateReprise;}
	...
	function PutDateReprise($DateReprise){$this->DateReprise = $DateReprise;}
	...
	function Validate($ActionPHP){
		...
		$PS = $Sql->ConstruireSQL("@DateDebut", DateMysqltoFr($this->DateDebut, C_DATE_MYSQL), $PS);
		$PS = $Sql->ConstruireSQL("@DateReprise", DateMysqltoFr($this->DateReprise, C_DATE_MYSQL), $PS);
;
